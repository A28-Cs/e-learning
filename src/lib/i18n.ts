...
const dict = {
  ...
  notifSupport: { ar: "رسالة دعم فني جديدة! 💬", en: "New support message! 💬" },
  ...
  phoneRequiredTeacher: { ar: "رقم التليفون إجباري للمدرسين — بنستخدمه للتواصل بخصوص تحويل المبالغ المستحقة.", en: "Phone number is required for teachers — we use it to arrange payout transfers." },
  teacherPhoneRequiredNote: { ar: "لازم تسجّل رقم تليفونك الأول عشان نقدر نتواصل معاك بخصوص تحويل المستحقات.", en: "Please add your phone number first so we can reach you about payout transfers." },
  completeProfile: { ar: "أكمل البروفايل", en: "Complete profile" },
  navSupport: { ar: "الدعم الفني", en: "Support" },
  supportTitle: { ar: "الدعم الفني", en: "Support" },
  adminSupport: { ar: "تذاكر الدعم", en: "Support Tickets" },
  newTicket: { ar: "تذكرة جديدة", en: "New ticket" },
  ticketSubject: { ar: "الموضوع", en: "Subject" },
  ticketMessage: { ar: "رسالتك", en: "Your message" },
  sendTicket: { ar: "إرسال", en: "Send" },
  noTickets: { ar: "مفيش تذاكر لسه", en: "No tickets yet" },
  statusOpen: { ar: "مفتوحة", en: "Open" },
  statusClosed: { ar: "مقفولة", en: "Closed" },
  ticketClosedNote: { ar: "التذكرة دي مقفولة — ابعت رسالة تانية لو محتاج تفتحها تاني.", en: "This ticket is closed — send a message to reopen it." },
  closeTicket: { ar: "قفل التذكرة", en: "Close ticket" },
  reopenTicket: { ar: "إعادة فتح", en: "Reopen" },
  typeMessage: { ar: "اكتب ردك…", en: "Type a message…" },
  send: { ar: "إرسال", en: "Send" },
  needsReply: { ar: "محتاجة رد", en: "Needs reply" },
  backToTickets: { ar: "الرجوع للتذاكر", en: "Back to tickets" },
